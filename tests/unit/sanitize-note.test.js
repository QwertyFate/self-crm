// UNIT tests for utils/sanitize-note.js — a pure function: a string goes in,
// a string comes out, no database and no network. Each test: arrange an
// input, act by calling the function, assert on the result.
...
describe('sanitizeNote', () => {
  ...
  test('only http, https and mailto links keep their address', () => {
    ...
    assert.equal(sanitizeNote('<a href="ftp://x">f</a>'), '<a>f</a>', 'ftp dropped');
